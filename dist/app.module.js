...
const contract_model_1 = require("./modules/db/models/contract.model");
const db_module_1 = require("./modules/db/db.module");
const ipfs_module_1 = require("./modules/ipfs/ipfs.module");
const metadata_model_1 = require("./modules/db/models/metadata.model");
const common_1 = require("@nestjs/common");
const sequelize_1 = require("@nestjs/sequelize");
const token_model_1 = require("./modules/db/models/token.model");
const web3_module_1 = require("./modules/web3/web3.module");
const whitelist_model_1 = require("./modules/db/models/whitelist.model");
const wallet_model_1 = require("./modules/db/models/wallet.model");
const transaction_model_1 = require("./modules/db/models/transaction.model");
